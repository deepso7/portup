...
- When writing infrastructure code with Alchemy, inspect `.repos/alchemy/` for examples of idiomatic usage, tests, module structure, and API design.

## Agent skills

### Issue tracker

Issues live in this repo's GitHub Issues (`deepso7/portup`), managed via the `gh` CLI. See `docs/agents/issue-tracker.md`.

### Triage labels

Default label vocabulary — each canonical role maps to a label of the same name. See `docs/agents/triage-labels.md`.
